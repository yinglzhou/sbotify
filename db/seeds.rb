...
ApplicationRecord.transaction do 
    ...
    Album.create!(name: "Nicole", artist_id: 1) #1
    Album.create!(name: "Give or Take", artist_id: 2) #2
    ...
    puts "Creating songs..."
    Song.create!(title: "Before", duration: "3:54", album_id: 1, artist_id: 1)
    Song.create!(title: "High School in Jakarta", duration: "3:39", album_id: 1, artist_id: 1)
    Song.create!(title: "Backburner", duration: "3:56", album_id: 1, artist_id: 1)
    Song.create!(title: "Keeping Tabs", duration: "2:57", album_id: 1, artist_id: 1)
    Song.create!(title: "The Apartment We Won't Share", duration: "2:29", album_id: 1, artist_id: 1)
    Song.create!(title: "Facebook Friends", duration: "3:57", album_id: 1, artist_id: 1)
    Song.create!(title: "Anaheim", duration: "4:14", album_id: 1, artist_id: 1)
    Song.create!(title: "Milk Teeth", duration: "2:50", album_id: 1, artist_id: 1)
    Song.create!(title: "Autumn", duration: "3:52", album_id: 1, artist_id: 1)
    Song.create!(title: "Oceans & Engines", duration: "5:36", album_id: 1, artist_id: 1)
    Song.create!(title: "On The Drive Home", duration: "4:16", album_id: 1, artist_id: 1)
    Song.create!(title: "Take A Chance With Me", duration: "5:03", album_id: 1, artist_id: 1)


    Song.create!(title: "Let Me Go", duration: "2:56", album_id: 2, artist_id: 2)
    Song.create!(title: "Scarred", duration: "2:58", album_id: 2, artist_id: 2)
    Song.create!(title: "dec 11th", duration: "1:13", album_id: 2, artist_id: 2)
    Song.create!(title: "This Will Do", duration: "2:55", album_id: 2, artist_id: 2)
    Song.create!(title: "Get To You", duration: "3:25", album_id: 2, artist_id: 2)
    Song.create!(title: "Tryna Be", duration: "2:50", album_id: 2, artist_id: 2)
    Song.create!(title: "Make You Mine", duration: "3:20", album_id: 2, artist_id: 2)
    Song.create!(title: "july 16th", duration: "1:50", album_id: 2, artist_id: 2)
    Song.create!(title: "For Tonight", duration: "3:12", album_id: 2, artist_id: 2)
    Song.create!(title: "Lost Me", duration: "3:00", album_id: 2, artist_id: 2)
    Song.create!(title: "Lie Again", duration: "3:02", album_id: 2, artist_id: 2)
    Song.create!(title: "Another Heartbreak", duration: "4:09", album_id: 2, artist_id: 2)
    Song.create!(title: "At Least We Tried", duration: "3:32", album_id: 2, artist_id: 2)
    Song.create!(title: "Remind Me", duration: "3:24", album_id: 2, artist_id: 2)
    Song.create!(title: "Unholy Matrimony", duration: "3:20", album_id: 2, artist_id: 2)
